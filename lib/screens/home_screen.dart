		...
		return Scaffold(
			...
			body: Stack(
				...
				children: <Widget>[
					...
					BlurredContainer(alignment: Alignment.bottomCenter, height: MediaQuery.of(context).size.height*0.25, horizontalOffset: 0.0, verticalOffset: 0.0, color: Colors.black.withOpacity(0.6)),
					Positioned(
						bottom: 0.0,
						right: 0.0,
						left: 0.0,
